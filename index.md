...
This page explains what the ASA BBQ customer mobile app does with your information. We've kept it short and in plain English, because most privacy policies are neither. If anything below isn't clear, write to us at **asabbq.restaurant@gmail.com** and we'll explain.
...
- **Delete your account and order history.** Email **asabbq.restaurant@gmail.com** from the address tied to your Google sign-in. We'll confirm and then remove your account and the orders linked to it. The full step-by-step lives at our [account-deletion page](./delete-account/).
...
We do not ask you to verify your identity beyond using the same email you signed in with. If you can't sign in (for example, you've lost access to your Google account), write to **asabbq.restaurant@gmail.com** with enough detail to confirm the orders are yours, and we'll help.
